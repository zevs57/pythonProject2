...
def table_point():
    """
    Функция сверяет с таблицей (table.txt) набран ли новый максимум очков, если набран,
    спрашивает имя игрока и записывает в конец таблицы имя и points.
    :return:
    """
...
sound2 = pygame.mixer.Sound('data/punch.wav')
